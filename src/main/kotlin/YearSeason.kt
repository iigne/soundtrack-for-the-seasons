...
data class YearSeason(
    ...
    val seasonEnd: LocalDateTime = LocalDateTime.of(getSeasonEndYear(date), season.months.last().value, season.months.last().length(Year.of(getSeasonEndYear(date)).isLeap), 23, 59),
